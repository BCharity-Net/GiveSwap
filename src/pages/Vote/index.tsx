import { ChainId, JSBI, TokenAmount } from 'goodswap-sdk'
      ...
      <TopSection gap="md">
        <VoteCard>
          ...
          <CardSection>
            <AutoColumn gap="md">
              <RowBetween>
                <TYPE.white fontWeight={600}>{t('GiveSwapGovernance')}</TYPE.white>
              </RowBetween>
              <RowBetween>
                <TYPE.white fontSize={14}>
                  {t(
                    'scam-tokens-represent-voting-shares-in-GiveSwap-governance-you-can-vote-on-each-proposal-yourself-or-delegate-your-votes-to-a-third-party'
                  )}
                </TYPE.white>
              </RowBetween>
              <ExternalLink
                ...
                target="_blank"
              >
                <TYPE.white fontSize={14}>{t('read-more-about-GiveSwap-governance')}</TYPE.white>
              </ExternalLink>
            </AutoColumn>
          </CardSection>
          <CardBGImage />
