          ...
          <AutoColumn gap="lg" style={{ width: '100%' }}>
            ...
            {!account ? (
              ...
              <>
                <ButtonSecondary>
                  <RowBetween>
                    <ExternalLink href={'https://info.GiveSwap.app/#/account/' + account}>
            ...
            <AutoColumn justify={'center'} gap="md">
              <Text textAlign="center" fontSize={14} style={{ padding: '.5rem 0 .5rem 0' }}>
                {hasV1Liquidity ? t('GiveSwap-v1-liquidity-found') : t('dont-see-a-pool-you-joined')}{' '}
