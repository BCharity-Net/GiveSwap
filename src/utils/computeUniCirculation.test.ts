...
describe('computeUniCirculation', () => {
  ...
  it('before staking', () => {
    expect(computeUniCirculation(token, BigInt(0), undefined)).toEqual(tokenAmount(150_000_000))
    expect(computeUniCirculation(token, BigInt(1600387200), undefined)).toEqual(tokenAmount(150_000_000))
  })
  it('mid staking', () => {
