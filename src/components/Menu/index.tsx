    ...
    <StyledMenu ref={node as any}>
      ...
      {open && (
        <MenuFlyout>
          ...
          <MenuItem id="link" href="https://bcharityfi.medium.com/">
            <BookOpen size={14} />
            Medium
          </MenuItem>
          <MenuItem id="link" href="https://github.com/BCharity-Net/GiveSwap">
            <GitHub size={14} />
            Github
          </MenuItem>
          <MenuItem id="link" href="https://twitter.com/BCharityFi">
            <Twitter size={14} />
            Twitter
          </MenuItem>
          <MenuItem id="link" href="https://t.me/BCharitynet">
            <Navigation size={14} />
            Telegram
          </MenuItem>
